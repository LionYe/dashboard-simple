...
;(function ($, window, undefined)
{
    ...
    function init()
    {
        ...
        //renderSearchField.call(this);   源码改动之干掉模糊搜索功能   @song ze ye
    ...
    */
            ...
            if (actionItems.length > 0)
            {
                ...
                if (this.options.ajax)
                {
                    var refreshIcon = tpl.icon.resolve(getParams.call(this, { iconCss: css.iconRefresh })),
                        // 刷新按钮样式冲突强制限制其样式 @song ze ye  actionButton修改为actionRefreshButton
                        refresh = $(tpl.actionRefreshButton.resolve(getParams.call(this,
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "All",
            infos: "显示 {{ctx.start}} 到 {{ctx.end}} 条，共 {{ctx.total}} 条",
            loading: "Loading...",
        ...
        templates: {
            ...
            actionRefreshButton: "<button class=\"btn btn-default btn-refresh\" type=\"button\" title=\"{{ctx.text}}\">{{ctx.content}}</button>",   /** 刷新按钮样式冲突强制限制其样式 @song ze ye **/
